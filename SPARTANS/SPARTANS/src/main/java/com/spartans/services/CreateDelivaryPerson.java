 ...
 * @author Rahul
 */
public class CreateDelivaryPerson extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String delivaryPersonJson = request.getParameter("delivaryPersonJson");
            String result = new DelivaryManager().createDelivaryPerson(delivaryPersonJson);
            out.write(result);
        } catch (Exception ex) {
